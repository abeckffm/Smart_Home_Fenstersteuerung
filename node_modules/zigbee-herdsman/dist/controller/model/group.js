...
class Group extends entity_1.default {
    ...
    removeFromNetwork() {
        return __awaiter(this, void 0, void 0, function* () {
            for (const endpoint of this._members) {
                yield endpoint.removeFromGroup(this);
            }
    ...
    write(clusterKey, attributes, options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield entity_1.default.adapter.sendZclFrameToGroup(this.groupID, frame, options.srcEndpoint);
            }
            catch (error) {
    ...
    getOptionsWithDefaults(options, direction) {
        ...
        return Object.assign({ direction, srcEndpoint: null, reservedBits: 0, manufacturerCode: null, transactionSequenceNumber: null }, providedOptions);
    }
}
