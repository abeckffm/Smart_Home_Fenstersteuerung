...
class Adapter extends events_1.default.EventEmitter {
     ...
     * Utility
     */
    static create(networkOptions, serialPortOptions, backupPath, adapterOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            const { ZStackAdapter } = yield Promise.resolve().then(() => __importStar(require('./z-stack/adapter')));
            const { DeconzAdapter } = yield Promise.resolve().then(() => __importStar(require('./deconz/adapter')));
            const { ZiGateAdapter } = yield Promise.resolve().then(() => __importStar(require('./zigate/adapter')));
            const { EZSPAdapter } = yield Promise.resolve().then(() => __importStar(require('./ezsp/adapter')));
            let adapters;
