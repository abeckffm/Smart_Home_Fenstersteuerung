...
class Znp extends events_1.default.EventEmitter {
    ...
    skipBootloader() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.serialPort) {
                yield this.setSerialPortOptions({ dtr: false, rts: false });
                yield utils_1.Wait(150);
                yield this.setSerialPortOptions({ dtr: false, rts: true });
                yield utils_1.Wait(150);
                yield this.setSerialPortOptions({ dtr: false, rts: false });
                yield utils_1.Wait(150);
            }
    ...
    request(subsystem, command, payload, waiterID = null, expectedStatuses = [ZnpCommandStatus.SUCCESS]) {
        if (!this.initialized) {
        ...
        return this.queue.execute(() => __awaiter(this, void 0, void 0, function* () {
            ...
            if (object.type === constants_1.Type.SREQ) {
                ...
                const result = yield waiter.start().promise;
