...
class Controller extends events_1.default.EventEmitter {
    ...
    touchlinkIdentify(ieeeAddr, channel) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.touchlink.identify(ieeeAddr, channel);
        });
    }
    touchlinkScan() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    touchlinkFactoryReset(ieeeAddr, channel) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    permitJoin(permit, device, time) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.permitJoinInternal(permit, 'manual', device, time);
        });
    }
    permitJoinInternal(permit, reason, device, time) {
        return __awaiter(this, void 0, void 0, function* () {
            if (permit) {
                yield this.adapter.permitJoin(254, !device ? null : device.networkAddress);
                yield this.greenPower.permitJoin(254);
                ...
                this.permitJoinNetworkClosedTimer = setInterval(() => __awaiter(this, void 0, void 0, function* () {
                    yield this.adapter.permitJoin(254, !device ? null : device.networkAddress);
                    yield this.greenPower.permitJoin(254);
                }), 200 * 1000);
                if (typeof time === 'number') {
                    this.permitJoinTimer = setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                        yield this.permitJoinInternal(false, 'timer_expired');
                    }), time * 1000);
                }
                const data = { permitted: true, reason };
                ...
                const data = { permitted: false, reason };
                this.emit(Events.Events.permitJoinChanged, data);
            }
        });
    }
    ...
    stop() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.permitJoinInternal(false, 'manual');
